...
(async () => {
  ...
  console.log(
    "balance wallet4: ",
    utils.formatEther(await wallet4.getBalance())
  );
  console.log(
    "balance wallet4: ",
    utils.formatEther(await wallet5.getBalance())
  );
  console.log(
    "balance wallet4: ",
    utils.formatEther(await wallet6.getBalance())
  );
  ...
  console.log(
    "after balance wallet4: ",
    utils.formatEther(await wallet4.getBalance())
  );
  console.log(
    "after balance wallet5: ",
    utils.formatEther(await wallet5.getBalance())
  );
  console.log(
    "after balance wallet6: ",
    utils.formatEther(await wallet6.getBalance())
  );
